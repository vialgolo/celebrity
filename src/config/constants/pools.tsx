...
export const vaultPoolConfig = {
  [VaultKey.CakeVault]: {
    name: <Trans>Auto CELEBRITY</Trans>,
    description: <Trans>Automatic restaking</Trans>,
    autoCompoundFrequency: 5000,
    gasLimit: 380000,
    tokenImage: {
      primarySrc: `/images/tokens/${tokens.celebrity.address}.svg`,
      secondarySrc: '/images/tokens/autorenew.svg',
    },
  },
  [VaultKey.IfoPool]: {
    name: 'IFO CELEBRITY',
    description: <Trans>Stake CELEBRITY to participate in IFOs</Trans>,
...
const pools: SerializedPoolConfig[] = [
  {
    sousId: 0,
    stakingToken: serializedTokens.celebrity,
    earningToken: serializedTokens.celebrity,
    contractAddress: {
      97: '0x1d32c2945C8FDCBc7156c553B7cEa4325a17f4f9',
      56: '0x984A0CFe426991657622843F4ac34754225a1D70',
    },
