...
import { ICelebrityPair } from '../config/abi/types/IPancakePair'
...
export function usePairContract(pairAddress?: string, withSignerIfPossible?: boolean): ICelebrityPair | null {
