...
import { MintResponse, SwapResponse, BurnResponse, TokenDayData, PairDayData, CelebrityDayData } from './types'
...
export const mapDayData = (tokenDayData: TokenDayData | CelebrityDayData): ChartEntry => ({
