...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and CELEBRITY pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and CELEBRITY pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from CELEBRITY pool', data)
  }
