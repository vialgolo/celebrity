...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'CELEBRITY card' },
    { src: 'green', alt: 'Green CELEBRITY card with up arrow' },
    { src: 'red', alt: 'Red Celebrity card with down arrow' },
    { src: 'top-right', alt: 'CELEBRITY card' },
  ],
}
