  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active CelebritySwap Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold CELEBRITY'),
      bodyText: [t('Each NFT costs CELEBRITY to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://pancakeswap.finance/swap?outputCurrency=0x0296915947d7F3F80663C5cb4343E9BBf0C50F09"
            target="_blank"
            width="100%"
          >
            {t('Buy CELEBRITY')}
