...
const UserPrizeGrid: React.FC<{ userTradingInformation?: UserTradingInformationProps }> = ({
  ...
  const { celebrityReward, lazioReward, portoReward, santosReward, dollarValueOfTokensReward } = useCompetitionRewards({
    userCakeRewards,
    userLazioRewards,
    userPortoRewards,
    userSantosRewards,
        ...
        <tr>
          <BoldTd>
            <Flex flexDirection="column">
              <Text bold>{celebrityReward.toFixed(4)} CELEBRITY</Text>
