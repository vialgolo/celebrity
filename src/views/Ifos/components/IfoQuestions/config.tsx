...
const config = [
  {
    ...
    description: [
      <Trans>
        ...
        CELEBRITY up to the maximum commit limit, which is published along with the IFO voting proposal. The Private Sale has
        no participation fee.
      </Trans>,
      <Trans>
        In the Public Sale, everyone with an active CelebritySwap profile can commit. However the maximum amount of CELEBRITY
        user can commit, is equal to the average CELEBRITY balance in the IFO CELEBRITY pool prior to the IFO. And there’s a fee
  ...
  },
  {
    ...
    description: [
      ...
      <Trans>Just remember you need an active CelebritySwap Profile in order to participate.</Trans>,
    ],
  },
  {
  ...
  },
  {
    ...
    description: [<Trans>The CELEBRITY from the participation fee will be thrown into the weekly token burn.</Trans>],
  },
  {
    title: <Trans>How can I get an achievement for participating in the IFO?</Trans>,
    description: [
      <Trans>You need to contribute a minimum of about 10 USD worth of CELEBRITY to either sale.</Trans>,
      <Trans>
