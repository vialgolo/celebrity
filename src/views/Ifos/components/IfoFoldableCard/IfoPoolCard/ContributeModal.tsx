...
const ContributeModal: React.FC<Props> = ({
  ...
  const label = currency === tokens.celebrity ? t('Max. CELEBRITY entry') : t('Max. token entry')
      ...
      <ModalBody maxWidth="360px">
        ...
        <Box p="2px">
          ...
          {isWarning && (
            ...
            >
              {valueWithTokenDecimals.isGreaterThan(userCurrencyBalance)
                ...
                : t('Exceeded max CELEBRITY entry')}
            </Text>
          )}
          ...
          <Text color="textSubtle" fontSize="12px" mb="24px">
            {t(
              'If you don’t commit enough CELEBRITY, you may not receive any IFO tokens at all and will only receive a full refund of your CELEBRITY.',
            )}
            <Link
              fontSize="12px"
              display="inline"
