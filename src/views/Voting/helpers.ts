...
export const generateMetaData = () => {
  return {
    plugins: {},
    network: 56,
    strategies: [{ name: 'celebrity', params: { symbol: 'CELEBRITY', address: tokens.celebrity.address, decimals: 18 } }],
  }
}
...
function verifyDefaultContract(blockNumber: number) {
  return {
    Celebrity: ContractDeployedNumber.Celebrity < blockNumber,
