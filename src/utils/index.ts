...
import { ICelebrityRouter02 } from 'config/abi/types/IPancakeRouter02'
...
export function getRouterContract(_: number, library: Web3Provider, account?: string) {
  return getContract(ROUTER_ADDRESS, IPancakeRouter02ABI, getProviderOrSigner(library, account)) as ICelebrityRouter02
}
