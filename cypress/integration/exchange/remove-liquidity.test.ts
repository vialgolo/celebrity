describe('Remove Liquidity', () => {
  ...
  it('bnb-celebrity remove', () => {
    ...
    cy.get('#remove-liquidity-tokenb-symbol').should('contain.text', 'CELEBRITY')
  })

  it('celebrity-bnb remove', () => {
    cy.visit('/remove/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82/BNB')
    cy.get('#remove-liquidity-tokena-symbol').should('contain.text', 'CELEBRITY')
